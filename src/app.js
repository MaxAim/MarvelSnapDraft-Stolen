...
const DATA_URL = "https://raw.githubusercontent.com/hansenwebco/snap-data/master/";
//const SIGNALIO_SERVER = "wss://stone-donkey.onrender.com"
const SIGNALIO_SERVER = "ws://localhost:8080";
...
async function loadCards() {
    let result = await (await fetch("cards.json")).json();
